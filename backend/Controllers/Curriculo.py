...
class Curriculo(Controller):
	...
	def Listar(self,pedido_listar):
		return RespostaListar(BDCurriculo().pegarCurriculos("WHERE id_curso = %s LIMIT %s OFFSET %s",(pedido_listar.getId_curso(),str(pedido_listar.getQuantidade()),(str(pedido_listar.getQuantidade()*pedido_listar.getPagina())))))
