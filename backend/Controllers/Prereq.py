...
class Prereq(Controller):
	...
	def Listar(self,pedido_listar):
		disciplina = BDDisciplina().pegarDisciplina("WHERE nome = %s",(pedido_listar.getDisciplina()))
		return RespostaListar(Ass_disc_pre().pegarResumoAss("disciplina.id = %s",(disciplina.getId())))
