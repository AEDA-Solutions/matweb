angular.
  ...
  component('listarCurso', {
   ...
   component('cursoPcampus', {
    ...
    controller: ['ApiCursoPCampus', 'MatWebGlobals','ApiFluxoListar','$routeParams','$scope', function            Listar(ApiCursoPCampus,MatWebGlobals,ApiFluxoListar,$routeParams,$scope) {
